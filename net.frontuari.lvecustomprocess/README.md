...
- New callout
    ...
    * Example: net.frontuari.lvecustomprocess.callout.CStringFormat

- New process
    * Name: PName
    * Package: net.frontuari.lvecustomprocess.process
    * Example: net.frontuari.lvecustomprocess.process.PGenerateWithholding

- New form
    * Name: FName
    * Package: net.frontuari.lvecustomprocess.form
    * Example: net.frontuari.lvecustomprocess.form.FMultiPayment

- New event
    * Name: EName
    * Package: net.frontuari.lvecustomprocess.event
    * Example: net.frontuari.lvecustomprocess.event.EAfterCompleteInvoice

- New model (extends class X)
    * Name: MName
    * Package: net.frontuari.lvecustomprocess.model
    * Example: net.frontuari.lvecustomprocess.model.MTableExample

## Folder estructure

```
    net.frontuari.lvecustomprocess
        |_.settings
        ...
        |   |_ProcessFactory.xml
        |_src
            |_net.frontuari.lvecustomprocess
                |_base (plugin core)
...
- New callout
    * Create callout in package `net.frontuari.lvecustomprocess.callout`, extends from `CustomCallout`
    * Register callout in `net.frontuari.lvecustomprocess.component.CalloutFactory`. Example:
...
- New process
    * Create process in package `net.frontuari.lvecustomprocess.process`, extends from `CustomProcess`
    * Register process in `net.frontuari.lvecustomprocess.component.ProcessFactory`. Example:
...
- New form
    * Create form in package `net.frontuari.lvecustomprocess.form`, extends from `CustomForm`
    * Register form in `net.frontuari.lvecustomprocess.component.FormFactory`. Example:
...
- New event
    * Create event in package `net.frontuari.lvecustomprocess.event`, extends from `CustomEvent`
    * Register event in `net.frontuari.lvecustomprocess.component.EventFactory`. Example:
...
- New model (extends form class X)
    * Create model in package `net.frontuari.lvecustomprocess.model`, extends class `X`. Example: `X_TL_TableExample -> MTableExample`
    * Register model in `net.frontuari.lvecustomprocess.component.ModelFactory`. Example:
