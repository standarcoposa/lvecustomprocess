 ...
 *  @author Jorge Colmenarez, 2023-05-05 15:52
 *  FR: Support for Organization Filter
 */
public class InvoiceNGL extends FTUProcess {
	...
	//	Added by Jorge Colmenarez, 2023-05-05 15:02
	/** Organization				*/
	...
	protected String doIt() throws Exception {
		...
		if (log.isLoggable(Level.INFO)) log.info("C_AcctSchema_ID=" + p_C_AcctSchema_ID 
			...
			//	Added by Jorge Colmenarez, 2023-05-05 15:03
	...
	private String createGLJournal()
	{
		...
		for (int i = 0; i < list.size(); i++)
		{
			...
			if (AD_Org_ID != gl.getAD_Org_ID())
			{
				...
				lossTotal = Env.ZERO;
				journal = null;
				//	Added by Jorge Colmenarez, 2023-05-05 12:01
				//	Support for create new Journal 
				org = null;
